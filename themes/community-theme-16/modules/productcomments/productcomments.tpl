                ...
                {if $is_logged}
                  {if !$comment.customer_advice}
                    <li>
                      ...
                      <button class="usefulness_btn btn btn-xs btn-default" data-is-usefull="1" data-id-product-comment="{$comment.id_product_comment}">
                        <span>{l s='Yes' mod='productcomments'}</span>
                      </button>
                      <button class="usefulness_btn btn btn-xs btn-default" data-is-usefull="0" data-id-product-comment="{$comment.id_product_comment}">
